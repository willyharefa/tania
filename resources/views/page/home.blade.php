...
<body>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="assets/template/petcare/assets/img/logo/logo.png" alt="">
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="menu-main d-flex align-items-center justify-content-end">
                                ...
                                <div class="main-menu f-right d-none d-lg-block">
                                    <nav> 
                                        <ul id="navigation">
                                            <li><a href="/">Home</a></li>
                                            <li><a href="/page/item">Pemesanan Barang</a></li>
    ...
    <main> 
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-7 col-lg-8 col-md-10 ">
                                ...
                                <div class="hero__caption">
                                    <span data-animation="fadeInUp" data-delay=".3s">Grooming Untuk Peliharaan Anda</span>
                                    <h1 data-animation="fadeInUp" data-delay=".3s">Sayangi Peliharaan Anda</h1>
                                    <p data-animation="fadeInUp" data-delay=".6s">Dibalik Hewan Yang Lucu Terdapat Tubuh Yang Bersih</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-xl-7 col-lg-8 col-md-10 ">
                                ...
                                <div class="hero__caption">
                                    <span data-animation="fadeInUp" data-delay=".3s">Menjual Pakan Dan Alat Peliharaan</span>
                                    <h1 data-animation="fadeInUp" data-delay=".3s">Berimakan Peliharaan Anda</h1>
                                    <p data-animation="fadeInUp" data-delay=".6s">Dibalik Tingkah Yang Lucu Ada Perut Yang Kenyang</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-sm-center">
                    <div class="cl-xl-7 col-lg-8 col-md-10">
                        ...
                        <div class="section-tittle text-center mb-70">
                            ...
                            <h2>Memberikan Pelayanan Terbaik</h2>
                        </div> 
                    </div>
                </div>
                    ...
                    <div class=" col-lg-4 col-md-6 col-sm-6">
                        <div class="single-services text-center mb-30">
                            <div class="services-ion">
                                <span class="">
                                    <img src="assets/img/feed.png" width="50">
                                </span>
                            </div>
                                <div class="services-cap">
                                    <h5><a href="/page/item">Pakan & Alat Peliharaan</a></h5>
                                    <p>Pakan Berkualitas Mengandung Gizi Yang Dibutuhkan dan Alat</p>
                                </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-services text-center mb-30">
                            ...
                            <div class="services-cap">
                                <h5><a href="/page/grooming">Pet Grooming</a></h5>
                                <p>Meemperlakukan Peliharaan Anda Dengan</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            ...
                            <div class="gallery-img size-img" style="background-image: url(assets/template/petcare/assets/img/gallery/gallery1.png);"></div>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img size-img" style="background-image: url(assets/template/petcare/assets/img/gallery/gallery2.png);"></div>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img size-img" style="background-image: url(assets/template/petcare/assets/img/gallery/gallery3.png);"></div>
                        </div>
                    </div>
                    <div class="col-lg-4  col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img size-img" style="background-image: url(assets/template/petcare/assets/img/gallery/gallery4.png);"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="assets/template/petcare/assets/img/gallery/team1.png" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="assets/template/petcare/assets/img/gallery/team2.png" alt="">
                            </div>
                            <div class="team-caption">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="assets/template/petcare/assets/img/gallery/team3.png" alt="">
                            </div>
                            <div class="team-caption">
        ...
        <!-- Team End -->
        <!--? Testimonial Start -->
        <div class="testimonial-area testimonial-padding section-bg" data-background="assets/template/petcare/assets/img/gallery/section_bg03.png">
            <div class="container">
                                ...
                                <div class="testimonial-caption ">
                                    ...
                                    <div class="testimonial-founder">
                                        <div class="founder-img mb-40">
                                            <img src="assets/template/petcare/assets/img/gallery/testi-logo.png" alt="">
        ...
        <div class="contact-animal-owner section-bg" data-background="assets/template/petcare/assets/img/gallery/section_bg04.png">
            <div class="container">
